...
module "read_elasticsearch_policy" {
  source  = "git::https://github.com/fewknow/devops.infra.modules.git//policies/read_elasticsearch?ref=1.0.24"
  name    = "read-elasticsesarch"
}

module "read_write_elasticsearch_policy" {
  source  = "git::https://github.com/fewknow/devops.infra.modules.git//policies/read_write_elasticsearch?ref=1.0.24"
...
module "policy_read_instance_metadata" {
  source = "git::https://github.com/fewknow/devops.infra.modules.git///policies/read_instance_metadata"
